...
def shortest_path(source, target):
    ...
    while(frontier.empty() != True):
        ...
        # current_node.action should be the list of neighboring pairs so
        # don't need to call neighbors_for_person

        # 'str' object has no attribute action
        # is current_node a str object
